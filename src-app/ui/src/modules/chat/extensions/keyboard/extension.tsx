...
function KeyboardShortcutsHelp() {
  ...
  return (
    ...
    // `flex-1 min-w-0`. It was not, from 2026-07-27 until this was fixed: the slot
    // was shrink-to-fit, so it had no free space, `flex-1` grew into nothing and
    // these tips were invisible for three months. Keep the two in sync — a
    // zero-basis child is only ever visible inside a parent that has room to give.
    <div
