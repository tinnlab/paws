        ...
        <Alert
          ...
          description={
            <Flex vertical className="w-full gap-2">
              {/* paws: GATED, not rewritten in place. An earlier pass edited
                  this sentence unconditionally, which meant deleting 'hub' from
                  PAWS_HIDDEN_MODULE_NAMES would restore the hub everywhere
                  EXCEPT here — a code edit needing manual revert, which is
