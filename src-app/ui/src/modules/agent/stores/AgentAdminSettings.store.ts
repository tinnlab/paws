 ...
 */
const AgentAdminSettingsDef = defineStore('AgentAdminSettings', {
  immer: true,
  state: {
...
export const AgentAdminSettings = registerLazyStore(AgentAdminSettingsDef)
export const useAgentAdminSettingsStore = AgentAdminSettingsDef.store
