...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/host-mount/project-extension/components/ProjectMountsPanel": {
    ...
    signals: [
      { kind: "branch", condition: "!project", line: 42 },
      { kind: "branch", condition: "!picked || Array.isArray(picked)", line: 50 },
      { kind: "branch", condition: "draft.some((m) => m.host_path === picked)", line: 51 },
      { kind: "loading", condition: "loading && draft.length === 0", line: 103 },
      { kind: "empty", condition: "draft.length === 0", line: 108 },
    ],
  },
  ...
  "modules/tunnel-auth/MagicLinkPage": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "Auth.$.isAuthenticated", line: 99 },
    ],
  },
  ...
  "modules/updater/components/UpdateBanner": {
    ...
    signals: [
      { kind: "branch", condition: "!available || dismissed", line: 31 },
      { kind: "branch", condition: "version", line: 43 },
      { kind: "branch", condition: "installing", line: 50 },
      { kind: "error", condition: "error", line: 78 },
    ],
  },
