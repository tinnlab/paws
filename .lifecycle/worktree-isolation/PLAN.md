...
- `src-app/ui/tests/common/test-context.ts` (ITEM-8)
- `src-app/server/src/modules/bio_mcp/embedded.rs`, `src-app/server/src/modules/file/utils/embedded.rs`, `src-app/server/src/modules/mcp/utils/embedded.rs` (ITEM-9)
- `src-app/desktop/ui/tests/global-setup.ts` (ITEM-10)
- `src-app/desktop/ui/tests/fixtures/port-manager.ts` (ITEM-11)
