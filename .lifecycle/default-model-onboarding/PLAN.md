...
- `src-app/ui/src/modules/onboarding/guides/getting-started/components/stores/defaultModelStep/{index.ts,state.ts,actions.gen.ts,actions/*.ts}` (new)
- `src-app/ui/src/modules/onboarding/gallery.tsx` and/or the gallery state-matrix inputs (edit — ITEM-11)
