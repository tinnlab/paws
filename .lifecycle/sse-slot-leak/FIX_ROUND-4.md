...
A fifth blind round was run on the post-round-4 diff as the final pre-merge
go/no-go; it returned **GO** with five `low` findings, all resolved — see
`FIX_ROUND-5.md`. This file's count refers to round 4's own findings, all
resolved above.
